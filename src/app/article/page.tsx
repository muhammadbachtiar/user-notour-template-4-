      ...
      <>
         {
            isSettingLoading ? (
                ...
                <section style={backgroundStyle} className={`relative rounded-md p-4 lg:p-14 bg-cover bg-bottom w-full h-44 md:h-60 lg:h-80 flex justify-start items-end`}>
                    ...
                    <div className="relative px-0 sm:px-8  text-start">
        ...
        <div className="w-full flex items-center justify-center">
                <div className="w-full px-6 sm:px-0 max-w-lg md:max-w-3xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl grid gap-2 dark:bg-gray-700 dark:border-gray-600grid grid-cols-3 lg:grid-cols-4 gap-y-6">
                    <div className="bg-transparent rounded-s-md col-span-4 lg:py-6 grid grid-cols-6">    
                        <div className="col-span-6 grid grid-cols-6 gap-8">
                             <div className="w-full col-span-6 grid grid-cols-6 justify-between items-center gap-4">
                                <div className="relative w-full col-span-6">
                                    <input id="search-dropdown" type='search' value={search} onChange={handleChange} className="block py-3 px-5 pe-12 w-full rounded-sm text-sm text-gray-900 bg-gray-100 placeholder:text-black border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Cari artikel ..." />
                            ...
                            <div className="col-span-6 grid grid-cols-6 gap-y-4 lg:gap-y-12 justify-items-center">
                                {isLoading ||  (!articles || !articles.pages[0] || articles.pages[0]?.data.length === 0) && isFetching ? (
                                    Array.from({ length: 6 }).map((_, index) => (
                                        <div key={index} className="col-span-6 md:col-span-3 px-2 lg:col-span-2 animate-pulse w-full">
